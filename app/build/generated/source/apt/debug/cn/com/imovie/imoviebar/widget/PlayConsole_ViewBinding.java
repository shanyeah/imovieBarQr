...
public class PlayConsole_ViewBinding implements Unbinder {
  ...
  @UiThread
  public PlayConsole_ViewBinding(final PlayConsole target, View source) {
    this.target = target;
    ...
    target.total_time = Utils.findRequiredViewAsType(source, R.id.left_time, "field 'total_time'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    PlayConsole target = this.target;
